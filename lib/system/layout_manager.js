...
/** @scope UI.LayoutManager.prototype */{
  ...
  _layoutForAnchoredView: function(view, anchor, options) {
    console.log('getting layout for ',anchor,' anchor - Manager: '+this.toString());
  ...
  _layoutForContentView: function(view, anchor) {
    console.log('getting layout for contentView - Manager: '+this.toString());
  ...
  _reflowContentView: function() {
    ...
    console.log('reflowing contentView. Manager: '+this.toString());
    ...
    if (element) {
      for (var prop in layout) {
        console.log('applying',prop,'to',layout[prop]);
